...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002549725870"))
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://graph.org/file/493e6b664fc531f210074-04b55d01c3abc10cf0.jpg https://i.ibb.co/DQ35zLZ/image.jpg",
    )
).split()
